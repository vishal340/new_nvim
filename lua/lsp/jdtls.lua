...
function M.start()
	...
	vim.list_extend(
		bundles,
		mason.glob_jars("java-debug-adapter/extension/server/com.microsoft.java.debug.plugin-*.jar")
	)
	vim.list_extend(bundles, mason.glob_jars("java-test/extension/server/*.jar"))
